            ...
            <div className="p-6 w-full">
              ...
              <div className="space-y-4">
                ...
                <div className="text-start">
                  ...
                  <input
                    class="block w-full text-md file:bg-fourth-color file:hover:bg-second-color file:border-0 file:text-second-color file:hover:text-fourth-color file:hover:bg-light-pink/20  text-Base-color border border-transparent-third-color rounded cursor-pointer bg-second-color focus:outline-none file:py-2 file:px-4"
                    name="image"
